 ...
 * 3x3 Matrix model.
 *
 * These are a start on some very simple 3x3 matrix routines.
 *
...
public class Matrix3x3
{
	...
	// Purpose: (Decrement matrix in-place: mat[i][j] = mat[i][j] -
	// subtrahend[i][j])
	// *************************************************************************
			...
			double[][] prod) // Out: -- Product
	{
		...
		prod[0][0] = mat_left[0][0] * mat_right[0][0] + mat_left[1][0] * mat_right[0][1] + mat_left[2][0] * mat_right[0][2];

		prod[0][1] = mat_left[0][0] * mat_right[1][0] + mat_left[1][0] * mat_right[1][1] + mat_left[2][0] * mat_right[1][2];

		prod[0][2] = mat_left[0][0] * mat_right[2][0] + mat_left[1][0] * mat_right[2][1] + mat_left[2][0] * mat_right[2][2];

		prod[1][0] = mat_left[0][1] * mat_right[0][0] + mat_left[1][1] * mat_right[0][1] + mat_left[2][1] * mat_right[0][2];

		prod[1][1] = mat_left[0][1] * mat_right[1][0] + mat_left[1][1] * mat_right[1][1] + mat_left[2][1] * mat_right[1][2];

		prod[1][2] = mat_left[0][1] * mat_right[2][0] + mat_left[1][1] * mat_right[2][1] + mat_left[2][1] * mat_right[2][2];

		prod[2][0] = mat_left[0][2] * mat_right[0][0] + mat_left[1][2] * mat_right[0][1] + mat_left[2][2] * mat_right[0][2];

		prod[2][1] = mat_left[0][2] * mat_right[1][0] + mat_left[1][2] * mat_right[1][1] + mat_left[2][2] * mat_right[1][2];

		prod[2][2] = mat_left[0][2] * mat_right[2][0] + mat_left[1][2] * mat_right[2][1] + mat_left[2][2] * mat_right[2][2];
